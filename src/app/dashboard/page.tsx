...
export default async function DashboardPage() {
  ...
  if (session.role === "owner") {
    ...
    const leadsLabel = "Buyer Inquiries";
    const isEmpty = !stats || (stats.activeListings === 0 && stats.pendingListings === 0);

    return (
      <main className="container-shell py-10 pb-16">
        <PanelShell role={session.role as any} currentPath="/dashboard">
          {/* Top bar */}
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                <Badge variant="secondary">
                  {session.role === "owner" ? "Property owner" : session.role}
                </Badge>
              </div>
            </div>
          ...
          {isEmpty ? (
            <div className="rounded-[28px] border border-slate-200 bg-white p-16 text-center shadow-sm">
              ...
              <Button asChild className="btn-brand rounded-full">
            ...
            <>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <Button asChild className="btn-brand rounded-full gap-2">
