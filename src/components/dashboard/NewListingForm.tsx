...
export function NewListingForm() {
  ...
  const handleSubmit = () => {
    startTransition(async () => {
      ...
      const result = await createListingAction({ ...form, amenities, images: imageList });
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_380px]">
      <div className="mb-2 rounded-2xl border border-[#1B4332]/15 bg-[#1B4332]/5 p-4 lg:col-span-2">
        <p className="text-sm font-semibold text-[#1B4332]">Post your personal property</p>
        <p className="text-xs text-slate-600 mt-1">
          Step 1: Details → Step 2: Location → Step 3: Photos. Your listing goes live after admin approval (usually within 24 hours).
        </p>
      </div>
      <div className="space-y-6">
        {/* Basic Info */}
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <h2 className="text-lg font-semibold text-slate-950">1. Basic Information</h2>
        ...
        {/* Location */}
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <h2 className="text-lg font-semibold text-slate-950">2. Location</h2>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label>City *</Label>
      ...
      <div className="space-y-6">
        <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm space-y-4">
          <h2 className="text-lg font-semibold text-slate-950">3. Property Photos</h2>
        ...
        <div className="rounded-[28px] border border-amber-100 bg-amber-50 p-5 text-sm text-amber-800 space-y-2">
          <div className="font-medium">Tips for faster approval</div>
          <ul className="space-y-1 list-disc list-inside text-amber-700">
            <li>Add at least 2 clear photos</li>
            <li>Include accurate price and area</li>
            <li>Write a detailed description</li>
            <li>Verify your contact details in profile</li>
          </ul>
        </div>
      </div>
    </div>
